    ...
    <div class="grid grid-cols-12 mt-20">
        ...
        <form class="space-y-6 col-start-4 col-span-6" action="new_course.php" method="POST">
            <div>
                ...
                <!-- <div>
                   Is it completed? <input type="checkbox" name="completed" id="completed"> 
                </div> -->
                <div>
                <label for="body" class="block text-sm font-medium text-gray-700">Memo</label>
                <div class="mt-1">
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
	...
	$course = (new CourseRepository())->saveCourse($title, $completed, $authenticatedUser->id);
	if ($course) {
